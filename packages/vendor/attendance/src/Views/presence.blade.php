...
$(document).ready(function() {
    ...
    // "terminée" : seule la vraie réponse AJAX peut afficher 100%.
    ...
    $('#exportExcelBtn').click(function() {
        ...
        window.location.href = "{{ route('admin.daily-attendance.presences.export-excel') }}?" + params;
    });
                ...
                if (response.success) {
                    ...
                    if (response.statistics) {
                        ...
                        if (response.statistics.total_attendances) {
                            statsHtml += 'Total présences : ' + response.statistics.total_attendances + '<br>';
                        }
                    ...
                    // Télécharger le PDF après un court délai
                    setTimeout(function() {
