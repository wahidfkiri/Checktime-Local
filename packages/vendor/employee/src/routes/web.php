...
Route::middleware(['web', 'auth', 'client.active'])->group(function () {
    ...
    Route::middleware('role_or_permission:admin|menu.areas')->prefix('areas')->name('areas.')->group(function () {
    ...
    Route::middleware('role_or_permission:admin|menu.departments')->prefix('departments')->name('departments.')->group(function () {
    ...
    Route::middleware('role_or_permission:admin|menu.employees')->prefix('employees')->name('employees.')->group(function () {
