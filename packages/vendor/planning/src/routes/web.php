...
Auth::routes();
// Chaque section a sa propre permission (menu.*) : un utilisateur admin passe
// toujours (voir role_or_permission), un utilisateur normal doit avoir reçu
// la permission correspondante via la page Utilisateurs.
Route::middleware(['web', 'auth', 'client.active'])->group(function () {

     // Gestion des Plannings
    Route::middleware('role_or_permission:admin|menu.work-hours')->prefix('work-hours')->name('work-hours.')->group(function () {
    ...
    Route::middleware('role_or_permission:admin|menu.employee-schedules')->prefix('employee-schedules')->name('employee-schedules.')->group(function () {
    ...
    Route::middleware('role_or_permission:admin|menu.schedules')->prefix('schedules')->name('schedules.')->group(function () {
        // Calendrier
