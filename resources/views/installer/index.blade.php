    ...
    <script>
        ...
        async function testApiConnection() {
            ...
            try {
                ...
                const data = await response.json();
                if (data.success) document.getElementById('apiTestResult').innerHTML = '<div class="alert alert-success alert-custom"><i class="fas fa-check-circle me-2"></i>Connexion API réussie !</div>';
                else document.getElementById('apiTestResult').innerHTML = '<div class="alert alert-danger alert-custom"><i class="fas fa-times-circle me-2"></i>' + (data.message || 'Connexion échouée.') + '</div>';
